...
\begin{tcolorbox}[colback=gray!5!white,colframe=gray!75!black,title=Full Natural Language Instructions,breakable]
...
\begin{itemize}
    ...
    \item \textbf{SEC Filing}: \href{https://www.sec.gov/Archives/edgar/data/1043236/000095012309013786/d67076exv10w35.htm}{\textcolor{blue}{View on EDGAR}}
\end{itemize}
\end{tcolorbox}
...
\begin{itemize}
    ...
    \item \textbf{SEC Filing}: \href{https://www.sec.gov/Archives/edgar/data/913277/000095013300001111/exh10-18.txt}{\textcolor{blue}{View on EDGAR}}
\end{itemize}
\end{tcolorbox}
